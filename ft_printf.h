...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/05/22 18:52:04 by ehaggon          #+#    #+#             */
...
void				print_nbr(t_argum *p);
void				print_unbr(t_argum *p);
void				print_unbr_base2(t_argum *p);
void				print_unbr_base8(t_argum *p);
void				print_unbr_base16(t_argum *p);

/*
** print_main_2.c
*/

void				print_void_pointer(t_argum *p);
void				print_float(t_argum *p);
...
void				print_nbr_case2(t_argum *p, intmax_t n, int sp);
void				print_nbr_case3(t_argum *p, intmax_t n, int pd);
void				print_nbr_case4(t_argum *p, intmax_t n, int sp, int pd);
void				print_nbr_driver(t_argum *p, intmax_t n, int sp, int pd);
...
int					get_nbr_space(t_argum *p, intmax_t n, int pd);
void				process_sp_plus_flag(t_argum *p, intmax_t n);
void				print_nbr_prototype(t_argum *p, intmax_t n);
...
void				print_unbr_case1(t_argum *p, uintmax_t n);
void				print_unbr_case2(t_argum *p, uintmax_t n, int sp);
void				print_unbr_case3(t_argum *p, uintmax_t n, int pd);
void				print_unbr_case4(t_argum *p, uintmax_t n, int sp, int pd);
void				print_unbr_driver(t_argum *p, uintmax_t n, int sp, int pd);
...
int					get_unbr_space(t_argum *p, uintmax_t n, int pd);
...
void				print_unbr_prototype(t_argum *p, uintmax_t n, uint8_t base);
void				process_hash_flag(t_argum *p, uint8_t base);
int					get_unbr_len_base(uintmax_t n, uint8_t base);
int					get_unbr_sp_base(t_argum *p, uintmax_t n, int d, uint8_t b);
...
void				print_base2_case1(t_argum *p, uintmax_t n);
void				print_base2_case2(t_argum *p, uintmax_t n, int sp);
void				print_base2_case3(t_argum *p, uintmax_t n, int pd);
void				print_base2_case4(t_argum *p, uintmax_t n, int sp, int pd);
void				print_base2_driver(t_argum *p, uintmax_t n, int sp, int pd);

/*
** print_octal_driver.c
*/

void				print_base8_case1(t_argum *p, uintmax_t n);
void				print_base8_case2(t_argum *p, uintmax_t n, int sp);
void				print_base8_case3(t_argum *p, uintmax_t n, int pd);
void				print_base8_case4(t_argum *p, uintmax_t n, int sp, int pd);
void				print_base8_driver(t_argum *p, uintmax_t n, int sp, int pd);

/*
** print_hex_driver.c
*/

void				print_base16_case1(t_argum *p, uintmax_t n);
void				print_base16_case2(t_argum *p, uintmax_t n, int sp);
void				print_base16_case3(t_argum *p, uintmax_t n, int pd);
void				print_base16_case4(t_argum *p, uintmax_t n, int sp, int pd);
void				print_base16_driver(t_argum *p, uintmax_t n, int s, int d);
...
void				print_vp_case2(t_argum *p, uintmax_t n, int sp);
void				print_vp_case3(t_argum *p, uintmax_t n, int pd);
void				print_vp_case4(t_argum *p, uintmax_t n, int sp, int pd);
void				print_vp_driver(t_argum *p, uintmax_t n, int sp, int pd);
...
void				print_float_driver(t_argum *p, t_float f);
void				print_float_(t_argum *p, t_float f);
