...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/05/27 13:52:23 by ehaggon          #+#    #+#             */
...
void	print_base8_case2(t_argum *p, uintmax_t n, int space)
{
	char c;
...
void	print_base8_case3(t_argum *p, uintmax_t n, int pads)
{
	put_nchar('0', pads);
	print_unbr_prototype(p, n, 8);
}

void	print_base8_case4(t_argum *p, uintmax_t n, int space, int pads)
{
...
void	print_base8_driver(t_argum *p, uintmax_t n, int space, int pads)
{
	if (!space && !pads)
